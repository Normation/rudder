...
/// is worth naming here when it turns out to be common. Nothing reads the list: it is what the
/// two vocabularies below are mapped onto, and `kind` is what does the mapping.
#[allow(dead_code)]
