...
mod tests {
    ...
    fn test_basename_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ path|basename }}}}", "data": {{ "path": "/tmp/dir/file" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_dirname_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ path|dirname }}}}", "data": {{ "path": "/tmp/dir/file" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_b64decode_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ encoded_data|b64decode }}}}", "data": {{ "encoded_data": "SGVsbG8sIEZlcnJpcyE=" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_b64encode_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ plain_data|b64encode }}}}", "data": {{ "plain_data": "Hello, Ferris!" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_urldecode_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ encoded_data|urldecode }}}}", "data": {{ "encoded_data": "Hello%2C%20Ferris%21" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_hash_filter_with_default() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "",  "template_string": "{{{{ data|hash }}}}", "data": {{ "data": "Hello, Ferris!" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_hash_filter_with_sha1() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|hash('sha-1') }}}}", "data": {{ "data": "Hello, Ferris!" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_hash_filter_with_sha256() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|hash('sha-256') }}}}", "data": {{ "data": "Hello, Ferris!" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_hash_filter_with_sha512() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|hash('sha-512') }}}}", "data": {{ "data": "Hello, Ferris!" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_quote_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|quote }}}}", "data": {{ "data": "A string to quote" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_regex_escape_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|regex_escape }}}}", "data": {{ "data": "^f.*o(.*)$" }} }}"#,
                test_path.display(),
                "minijinja"
            ),
            PolicyMode::Audit,
    ...
    fn test_regex_replace_filter() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|regex_replace('{}', '{}') }}}}", "data": {{ "data": "ansible" }} }}"#,
                test_path.display(),
                "minijinja",
                "^a.*i(.*)$",
                "a$1"
    ...
    fn test_regex_replace_filter_with_n() {
        ...
        unix::test(
            Path::new(BIN),
            &format!(
                r#"{{"path": "{}", "engine": "{}", "template_path": "", "datastate_path": "", "template_string": "{{{{ data|regex_replace('{}', '{}', 1) }}}}", "data": {{ "data": "ansible" }} }}"#,
                test_path.display(),
                "minijinja",
                "^a.*i(.*)$",
                "a$1"
