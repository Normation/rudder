// Template for Rudder technical reports, forked from ilm 1.4.0.
...
#let rudder-report(
  ...
  // Set the body font.
  //set text(size: 12pt, font: "Lato") // default is 11pt
  ...
  page(
    align(
      ...
      block(width: 90%)[
        ...
        #text(3em, font: "Raleway", weight: "semibold")[*#title*]
  ...
  //show heading: set text(hyphenate: false, font: "Raleway")
