...
function Technique-Dsc {
  ...
  $LocalClasses = Merge-ClassContext $LocalClasses $(Command-Execution -Command "dsc" -ComponentName "Command execution" -ReportId $ReportId -TechniqueName $TechniqueName -AuditOnly:$AuditOnly).get_item("classes")
}
