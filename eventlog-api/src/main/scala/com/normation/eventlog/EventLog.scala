...
trait EventLog  {
  ...
  val id : Option[Int] = eventDetails.id // autogenerated id, by the serialization system
  ...
  val principal : EventActor = eventDetails.principal
  
  val creationDate : DateTime = eventDetails.creationDate
   ...
   */
  val cause : Option[Int] = eventDetails.cause 

  
  val severity : Int = eventDetails.severity
