...
class SearchServerComponent(
  ...
  private[this] def searchServers = chooseTemplate("query","SearchServers",serverPortletTemplateFile)
  private[this] def content = chooseTemplate("content","query",searchServers)
