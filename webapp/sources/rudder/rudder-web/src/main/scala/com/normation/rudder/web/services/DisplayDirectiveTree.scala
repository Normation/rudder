...
object AgentCompat {
  final case object Dsc     extends AgentCompat {
    ...
    def directiveText: NodeSeq =
      <p>This Directive is based on a Technique version compatible with <b class="dsc">DSC agent</b>.</p>
  }
  ...
  final case object All     extends AgentCompat {
    ...
    def techniqueText: NodeSeq =
      <p>This Technique has at least a version compatible with both <b>Classic</b> and <b class="dsc">DSC</b> agents.</p>
    def directiveText: NodeSeq =
      <p>This Directive is based on a Technique version compatible with both <b>Classic</b> and <b class="dsc">DSC</b> agents.</p>
  }
