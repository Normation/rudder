      ...
      & "group-rudderid" #> <div class="form-group">
                      ...
                      <div class="position-relative align-items-center">
                        <input readonly="" class="form-control" value={nodeGroup.id.serialize}/>
                          <a class="my-2 mx-3 position-absolute end-0 top-0" title="Copy to clipboard" onclick={s"copy('${nodeGroup.id.serialize}')"}>
    ...
    & "group-rudderid" #> <div>
                    ...
                    <div class="position-relative align-items-center">
                      <input readonly="" class="form-control" value={target.target}/>
                        <a class="my-2 mx-3 position-absolute end-0 top-0" title="Copy to clipboard" onclick={s"copy('${target.target}')"}>
                          <i class="fa fa-clipboard"></i>
                      </a>
                    </div>
                  </div>
