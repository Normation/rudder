...
class CheckRemoveRuddercSetting(
  ...
  val settingDN = new DN("propertyName=rudder_generation_rudderc_enabled_targets,ou=Application Properties,cn=rudder-configuration")
  ...
  override def checks() : Unit = {
    (for {
      ...
      MigrationLoggerPure.error(s"Error when deleting deprecated rudderc preference 'rudder_generation_rudderc_enabled_targets': ${err.fullMsg} ")
    ).runNow
  }
}
