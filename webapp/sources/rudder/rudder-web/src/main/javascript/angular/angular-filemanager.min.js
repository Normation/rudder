!(function (e, r, n) {
  ...
  r.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]),
    ...
    n(e.document).on("contextmenu", '.main-navigation .table-files tr.item-list:has("td"), .item-list', function (r) {
      ...
      r.pageX >= e.innerWidth - i.width() && (r.pageX -= i.width()),
        ...
        i
          .hide()
          .css({ left: r.pageX - $(".filemanager-window").offset().left, top: r.pageY - $(".filemanager-window").offset().top })
          .show(),
        r.preventDefault();
    }),
  ...
  (function (e, r) {
    "use strict";
    e.module("FileManagerApp").controller("FileManagerCtrl", [
      "$scope",
      "$rootScope",
      "$window",
      "$translate",
        ...
        (e.config = t),
          ...
          (e.openImagePreview = function () {
            ...
            (e.apiMiddleware.apiHandler.inprocess = !0),
              e
                .modal("imagepreview", null, !0)
                .find("#imagepreview-target")
                .attr("src", e.apiMiddleware.getUrl(r))
                .unbind("load error")
          ...
          (e.modal = function (n, i, a) {
            var t = r("#" + n);
            return t.bsModal(i ? "hide" : "show"), (e.apiMiddleware.apiHandler.error = ""), (e.apiMiddleware.apiHandler.asyncSuccess = !1), !a || t;
          }),
          ...
          (e.compress = function () {
            ...
            return i && c(e.temp)
              ...
              : r
              ? void e.apiMiddleware.compress(e.temps, r, n.selectedModalPath).then(
                  function () {
          ...
          (e.extract = function () {
            ...
            return t && c(e.temp)
              ? ((e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename")), !1)
              : i
              ? void e.apiMiddleware.extract(r, i, n.selectedModalPath).then(
                  function () {
          ...
          (e.move = function () {
            ...
            return r && c(r)
              ? ((e.apiMiddleware.apiHandler.error = a.instant("error_cannot_move_same_path")), !1)
              : void e.apiMiddleware.move(e.temps, n.selectedModalPath).then(function () {
          ...
          (e.rename = function () {
            ...
            return !n || (i && e.fileNavigator.fileNameExists(n))
              ? ((e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename")), !1)
              : void e.apiMiddleware.rename(r).then(function () {
          ...
          (e.createFolder = function () {
            var r = e.singleSelection(),
              n = r.tempModel.name;
            return !n || e.fileNavigator.fileNameExists(n)
              ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"))
              : void e.apiMiddleware.createFolder(r).then(function () {
          ...
          (e.uploadFiles = function () {
            e.apiMiddleware.upload(e.uploadFileList, e.fileNavigator.currentPath).then(
              function () {
  ...
  (function (e) {
    ...
    r.directive("angularFilemanager", [
      "$parse",
      "fileManagerConfig",
      function (e, r) {
  ...
  (function (e) {
    ...
    e.module("FileManagerApp").service("chmod", function () {
      ...
      return (
        (e.prototype.toOctal = function (e, r) {
          var n = [];
          return (
            ["owner", "group", "others"].forEach(
              function (e, r) {
        ...
        (e.prototype.octalValues = { read: 4, write: 2, exec: 1 }),
        (e.prototype.codeValues = { read: "r", write: "w", exec: "x" }),
  ...
  (function (e) {
    ...
    r.filter("strLimit", [
      ...
      r.filter("humanReadableFileSize", [
        "$filter",
        "fileManagerConfig",
        function (e, r) {
          ...
          return function (e) {
            ...
            return Math.max(t, 0.1).toFixed(1) + " " + o;
          };
        },
      ]);
  })(angular),
  ...
  (function (e) {
    "use strict";
    e.module("FileManagerApp").config([
      "$translateProvider",
      function (e) {
  ...
  (function (e, r) {
    "use strict";
    e.module("FileManagerApp").service("apiHandler", [
      "$http",
      "$q",
      "$window",
      "$translate",
      ...
      function (e, n, i, a, t) {
        ...
        return (
          (o.prototype.deferredHandler = function (e, r, n, i) {
            return (
              (e && "object" == typeof e) || (this.error = "Error %s - Bridge response error, please check the API docs or this ajax response.".replace("%s", n)),
          ...
          (o.prototype.list = function (r, i, a) {
            var t = this,
              ...
              s = n.defer(),
              l = { action: "list", path: i };
            return (
              (t.inprocess = !0),
              (t.error = ""),
              e
                .post(r, l).then(function successCallback(x) {
                  o(x.data, s, x.status);
                },function errorCallback(x) {
                  o(x.data, s, x.status, "Unknown error listing, check the response");
                })
                ["finally"](function () {
                  t.inprocess = !1;
                }),
          ...
          (o.prototype.copy = function (r, i, t, o) {
            var s = this,
              l = n.defer(),
              d = { action: "copy", items: i, newPath: t };
            return (
              o && 1 === i.length && (d.singleFilename = o),
              (s.inprocess = !0),
              (s.error = ""),
              e
                .post(r, d).then(function successCallback(x) {
                  s.deferredHandler(x.data, l, x.status);
                }, function errorCallback(x) {
                  s.deferredHandler(x.data, l, x.status, a.instant("error_copying"));
                })
                ["finally"](function () {
                  s.inprocess = !1;
                }),
          ...
          (o.prototype.move = function (r, i, t) {
            var o = this,
              s = n.defer(),
              l = { action: "move", items: i, newPath: t };
            return (
              (o.inprocess = !0),
              (o.error = ""),
              e
                .post(r, l).then(function successCallback(x) {
                  o.deferredHandler(x.data, s, x.status);
                }, function errorCallback(x) {
                  o.deferredHandler(x.data, s, x.status, a.instant("error_moving"));
                })
                ["finally"](function () {
                  o.inprocess = !1;
                }),
          ...
          (o.prototype.remove = function (r, i) {
            var t = this,
              o = n.defer(),
              s = { action: "remove", items: i };
            return (
              (t.inprocess = !0),
              (t.error = ""),
              e
                .post(r, s).then(function successCallback(x) {
                  t.deferredHandler(x.data, o, x.status);
                }, function errorCallback(x) {
                  t.deferredHandler(x.data, o, x.status, a.instant("error_deleting"));
                })
                ["finally"](function () {
                  t.inprocess = !1;
                }),
            ...
            return (
              ...
              e
                .post(r, s).then(function successCallback(x) {
                  ...
                  t.deferredHandler(x.data, o, x.status, a.instant("error_getting_content"));
                })
                ["finally"](function () {
                  t.inprocess = !1;
                }),
          ...
          (o.prototype.edit = function (r, i, t) {
            var o = this,
              s = n.defer(),
              l = { action: "edit", item: i, content: t };
            return (
              (o.inprocess = !0),
              (o.error = ""),
              e
                .post(r, l).then(function successCallback(x) {
                  ...
                  o.deferredHandler(x.data, s, x.status, a.instant("error_modifying"));
                })
                ["finally"](function () {
                  o.inprocess = !1;
                }),
          ...
          (o.prototype.rename = function (r, i, t) {
            var o = this,
              s = n.defer(),
              l = { action: "rename", item: i, newItemPath: t };
            return (
              (o.inprocess = !0),
              (o.error = ""),
              e
                .post(r, l).then(function successCallback(x) {
                  ...
                  o.deferredHandler(x.data, s, x.status, a.instant("error_renaming"));
                })
                ["finally"](function () {
                  o.inprocess = !1;
                }),
            ...
            return (
              ...
              e
                ...
                .then(function successCallback(response) {
                  var r = new i.Blob([x.data]);
                  p.resolve(e), i.saveAs(r, o);
                }, function errorCallback(x) {
                  d.deferredHandler(x.data, p, x.status, a.instant("error_downloading"));
                })
                ["finally"](function () {
                  d.inprocess = !1;
                }),
          ...
          (o.prototype.downloadMultiple = function (t, o, s, l, d) {
            var c = this,
              p = n.defer(),
              m = { action: "downloadMultiple", items: o, toFilename: s },
              u = [t, r.param(m)].join("?");
            return l && !d && i.saveAs
              ? ((c.inprocess = !0),
                e
                  ...
                  .then(function successCallback(response) {
                    ...
                    c.deferredHandler(x.data, p, x.status, a.instant("error_downloading"));
                  })
                  ["finally"](function () {
                    c.inprocess = !1;
                  }),
                p.promise)
              : (!i.saveAs && i.console.log("Your browser dont support ajax download, downloading by default"), !!i.open(u, "_blank", ""));
          }),
          (o.prototype.compress = function (r, i, t, o) {
            var s = this,
              l = n.defer(),
              d = { action: "compress", items: i, destination: o, compressedFilename: t };
            return (
              (s.inprocess = !0),
              (s.error = ""),
              e
                .post(r, d).then(function successCallback(x) {
                  ...
                  s.deferredHandler(x.data, l, x.status, a.instant("error_compressing"));
                })
                ["finally"](function () {
                  s.inprocess = !1;
                }),
          ...
          (o.prototype.extract = function (r, i, t, o) {
            var s = this,
              l = n.defer(),
              d = { action: "extract", item: i, destination: o, folderName: t };
            return (
              (s.inprocess = !0),
              (s.error = ""),
              e
                .post(r, d).then(function successCallback(x) {
                  ...
                  s.deferredHandler(x.data, l, x.status, a.instant("error_extracting"));
                })
                ["finally"](function () {
                  s.inprocess = !1;
                }),
          ...
          (o.prototype.changePermissions = function (r, i, t, o, s) {
            ...
            return (
              ...
              (l.error = ""),
              e
                .post(r, c).then(function successCallback(x) {
                  l.deferredHandler(x.data, d, x.status);
                }, function errorCallback(x) {
                  l.deferredHandler(x.data, d, x.status, a.instant("error_changing_perms"));
                })
                ["finally"](function () {
                  l.inprocess = !1;
                }),
          ...
          (o.prototype.createFolder = function (r, i) {
            var t = this,
              o = n.defer(),
              s = { action: "createFolder", newPath: i };
            return (
              (t.inprocess = !0),
              (t.error = ""),
              e
                .post(r, s).then(function successCallback(x) {
                  ...
                  t.deferredHandler(x.data, o, x.status, a.instant("error_creating_folder"));
                })
                ["finally"](function () {
                  t.inprocess = !1;
                }),
        ...
        return (
          ...
          (i.prototype.refresh = function () {
            ...
            return (
              ...
              e
                .list()
                .then(function (r) {
                  (e.fileList = (r.result || []).map(function (r) {
          ...
          (i.prototype.buildTree = function (e) {
            function i(e, r, n) {
              ...
              if ((e.name.trim() && 0 !== n.trim().indexOf(e.name) && (e.nodes = []), e.name !== n))
                e.nodes.forEach(function (e) {
                  i(e, r, n);
                });
              else {
                for (var t in e.nodes) if (e.nodes[t].name === a) return;
                e.nodes.push({ item: r, name: a, nodes: [] });
              }
            ...
            function a(e, r) {
              r.push(e);
              for (var n in e.nodes) a(e.nodes[n], r);
            }
            function t(e, r) {
            ...
            var o = [],
              s = {};
            !this.history.length && this.history.push({ name: r.basePath ? r.basePath[0] : "", nodes: [] }), a(this.history[0], o), (s = t(o, e)), s && (s.nodes = []);
  ...
  angular.module("FileManagerApp").run([
    "$templateCache",
    function (e) {
      e.put(
