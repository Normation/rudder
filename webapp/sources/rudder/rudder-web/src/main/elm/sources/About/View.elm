...
import Html exposing (Html, a, button, div, h1, h4, i, label, p, pre, span, table, tbody, td, text, th, thead, tr)
                    ...
                    let
                        ...
                        relaysList relays ui =
                            let
                                ...
                                nbRelays =
                                    String.fromInt (List.length relays)
                            in
                            div [ class "mb-1" ]
                                [ div [ class "info" ]
                        ...
                        pluginsList plugins ui =
                            let
                                ...
                                nbPlugins =
                                    String.fromInt (List.length plugins)
                            in
                            div [ class "mb-1" ]
                                [ div [ class "info" ]
