...
nodesTab model details =
    let
        ...
        fun =
            byNodeCompliance model complianceFilters
        ...
        ( sortId, sortOrder ) =
            Dict.get rowId ui.openedRows |> Maybe.withDefault ( "Node", Asc )
        ...
        childs =
            Maybe.withDefault [] (Maybe.map .nodes details.compliance)
        ...
        groupsList =
            getAllElems model.groupsTree

        includedTargets =
            case details.rule.targets of
                [ Composition (Or include) _ ] ->
                    include

                _ ->
                    details.rule.targets
        ...
        infoSpecialTarget =
            if List.isEmpty specialTargets then
                ...
                div [ class "callout-fade callout-info" ]
                    ...
                    , text "The nodes of these targets "
                    , strong [] [ text "are not displayed " ]
