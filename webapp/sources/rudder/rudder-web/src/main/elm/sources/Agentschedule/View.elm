            ...
            , div [class "globalConf"]
              ...
              , div [class "form-group inline-input-group"]
                ...
                , div [class "input-group input-group-sm"]
                  ...
                  , span [class "input-group-text"][text ("Hour" ++ if selectedSettings.startHour > 1 then "s" else "")]
                  ...
                  , span [class "input-group-text"][text ("Minute" ++ if selectedSettings.startMinute > 1 then "s" else "")]
                  ]
                ]
              , div [class "form-group inline-input-group"]
                ...
                , div [class "input-group input-group-sm"]
                  ...
                  , span [class "input-group-text"][text ("Hour" ++ if selectedSettings.splayHour > 1 then "s" else "")]
                  ...
                  , span [class "input-group-text"][text ("Minute" ++ if selectedSettings.splayMinute > 1 then "s" else "")]
                  ]
                ]
              ]
            ]
