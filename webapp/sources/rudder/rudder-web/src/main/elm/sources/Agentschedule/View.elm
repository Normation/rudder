            ...
            div [ class "explanation-text" ]
                ...
                , case model.currentSettings of
                    Just currentSettings ->
                        let
                            selectedSettings =
                                case model.selectedSettings of
                                    Just s ->
                                        s
                                    ...
                                    , div [ class "row mb-2" ]
                                        ...
                                        , div [ class "col-sm-10" ]
                                            [ div [ class "input-group input-group-sm d-inline-flex w-auto" ]
                                                ...
                                                , label [ for "startHour", class "input-group-text" ]
                                                    [ text
                                                        ("Hour"
                                                            ++ (if selectedSettings.startHour > 1 then
                                                                    "s"
                                                ...
                                                , label [ for "startMinute", class "input-group-text" ]
                                                    [ text
                                                        ("Minute"
                                                            ++ (if selectedSettings.startMinute > 1 then
                                                                    "s"
                                    ...
                                    , div [ class "row mb-2" ]
                                        ...
                                        , div [ class "col-sm-10" ]
                                            [ div [ class "input-group input-group-sm d-inline-flex w-auto" ]
                                                ...
                                                , label [ for "splayHour", class "input-group-text" ]
                                                    [ text
                                                        ("Hour"
                                                            ++ (if selectedSettings.splayHour > 1 then
                                                                    "s"
                                                ...
                                                , label [ for "splayMinute", class "input-group-text" ]
                                                    [ text
                                                        ("Minute"
                                                            ++ (if selectedSettings.splayMinute > 1 then
                                                                    "s"
