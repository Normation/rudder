...
import Html.Attributes exposing (attribute, checked, class, disabled, for, href, id, selected, type_, value)
...
hours s =
    List.range 0 (clamp 0 5 ((s.interval // 60) - 1))


minutes : Schedule -> List Int
minutes s =
    List.range 0 (clamp 0 59 s.interval)
