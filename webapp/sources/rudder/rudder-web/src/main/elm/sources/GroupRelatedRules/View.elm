...
import Ui.Datatable exposing (Category, emptyCategory, filterSearch, getSubElems)
...
view model =
    let
        allMissingCategoriesId =
            List.map .id (getAllMissingCats model.ruleTree)

        treeFilters =
            model.ui.ruleTreeFilters
                        ...
                        [ case ruleTreeCategory model.ruleTree of
                            ...
                            Nothing ->
                                div [ class "alert alert-warning" ]
                                    ...
                                    , text
                                        ("No rules "
                                            ++ (if model.ruleTree == emptyCategory then
