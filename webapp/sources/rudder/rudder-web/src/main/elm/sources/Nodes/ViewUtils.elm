...
getSortFunction model n1 n2 =
    let
        order =
            case model.ui.filters.sortBy of
                Id ->
                    N.compare n1.id.value n2.id.value

                Hostname ->
                    N.compare n1.hostname n2.hostname
...
nodesTableHeader ui =
    ...
    tr [ class "head" ]
        [ th
            [ class (thClass filters Hostname)
            , rowspan 1
            , colspan 1
