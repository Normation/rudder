...
import Html exposing (Html, i, td, text, th, tr)
...
buildGroupsTable model groups =
    let
        ...
        rowTable r =
            let
                categoryName =
                    text (Maybe.withDefault "Groups" (Maybe.map (getCategoryName model) r.category))
...
groupsTableHeader groupFilters =
    ...
    tr [ class "head" ]
        ...
        , th
            ...
            [ text "Category" ]
        , th
            [ class (thClass tableFilters GlobalCompliance ++ " compliance-col")
            , rowspan 1
            , colspan 1
        ...
        , th
            [ class (thClass tableFilters TargetedCompliance ++ " compliance-col")
            , rowspan 1
            , colspan 1
