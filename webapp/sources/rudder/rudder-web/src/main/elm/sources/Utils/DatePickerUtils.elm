module Utils.DatePickerUtils exposing (userDefinedDatePickerSettings)
...
adjustAllowedTimesOfDayToClientZone baseZone clientZone today datetimeBeingProcessed =
    let
        processingPartsInClientZone =
            Time.Extra.posixToParts clientZone datetimeBeingProcessed

        todayPartsInClientZone =
            Time.Extra.posixToParts clientZone today

        startPartsAdjustedForBaseZone =
            Time.Extra.posixToParts baseZone datetimeBeingProcessed
