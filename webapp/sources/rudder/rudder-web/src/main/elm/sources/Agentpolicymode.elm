    ...
    case msg of
        ...
        GetGlobalPolicyModeResult res ->
            case res of
                Ok p ->
                    let
                        newModel =
                            { model | globalPolicyMode = p }

                        initModel =
                            if model.ui.form == GlobalForm then
                                let
                                    settings =
                                        model.currentSettings

                                    newSettings =
                                        { settings | policyMode = p }
                                in
                            ...
                            case model.ui.form of
                                ...
                                NodeForm _ ->
                                    let
                                        ...
                                        newSettings =
                                            { settings | policyMode = s.policyMode }
                                    in
        ...
        CloseModal ->
            let
                ...
                newModel =
                    { model | ui = { ui | modalState = NoModal } }
            in
            ( newModel, Cmd.none )
...
getUrl : Model -> String
getUrl model =
    model.contextPath ++ "/secure/configurationManager/directiveManagement"
