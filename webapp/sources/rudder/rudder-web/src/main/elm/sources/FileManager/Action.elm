...
import Http exposing (Body, emptyBody, expectBytesResponse, expectJson, header, request, stringBody)
import Http.Detailed
import Json.Decode as Decode exposing (Decoder, andThen, bool, fail, maybe, succeed)
import Json.Decode.Pipeline exposing (optional, required)
import Json.Encode
import List exposing (map)
import List.Extra
import String exposing (dropLeft)
import Url.Builder exposing (QueryParameter, string, toQuery)
...
handleFileUpdate r =
    case r of
        ...
        Err e ->
            FileUpdate (FileUpdateHttpError e)
