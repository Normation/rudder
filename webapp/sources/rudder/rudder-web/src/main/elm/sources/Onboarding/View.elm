...
import Html exposing (Html, a, b, button, div, form, h1, h3, i, input, label, li, span, text, ul)
import Html.Attributes exposing (checked, class, for, href, id, name, type_, value)
    ...
    let
        ...
        sidebarSection s =
            let
                ...
                sectionIndex =
                    case List.Extra.elemIndex s model.sections of
                        Just i ->
                            i
                ...
                activeClass =
                    if sectionIndex == model.activeSection then
                        "activeSection"
        ...
        summaryList section =
            let
                ( stateClass, iconClass, textItem ) =
                    case section of
                        Welcome ->
                            ( completeClass, completeIcon, "Rudder is correctly installed." )

                        Account s ac ->
                            case s of
                                Completed ->
                                    ( completeClass, completeIcon, "Your license will be setup." )

                                Warning ->
                                    ( warningClass, warningIcon, "There is a problem with your license credentials." )

                                _ ->
                                    ( defaultClass, defaultIcon, "No license has been linked yet to your Rudder installation." )
                ...
                Just s ->
                    case s of
                        ...
                        Account state settings ->
                            ...
                            , form [ class "wizard-form", name "wizard-account" ]
                                [ div [ class "form-group" ]
                                    ...
                                    , input
                                        [ class "form-control sm-width"
                                        , type_ "text"
                                        , name "rudder-username"
                                        , id "rudder-username"
                                        , value (Maybe.withDefault "" settings.username)
                                        , onInput
                                            (\str ->
                                                UpdateSection 1
                                                    (Account state
                                ...
                                , div [ class "form-group" ]
                                    ...
                                    , input
                                        [ class "form-control sm-width"
                                        , type_ "password"
                                        , name "rudder-password"
                                        , id "rudder-password"
                                        , value (Maybe.withDefault "" settings.password)
                                        , onInput
                                            (\str ->
                                                UpdateSection 1
                                                    (Account state
                        ...
                        GettingStarted _ ->
                            let
                                listSummary =
                                    case List.tail model.sections of
                                        Just l ->
                                            l
                            ...
                            , ul [ class "sections-summary" ]
                                (listSummary
                                 ...
                                 -- Remove "Getting Started" section from the summary
                                )
                            , div []
