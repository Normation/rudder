...
type alias ProvidersInfo =
    Dict Provider ProviderInfo
...
takeFirstExtProvider =
    List.head << filterExternalProviders
...
mergeUserNewInfo userForm =
    ...
    -- empty fields are invalid, we remove them for now but they may be used for explicit errors later
