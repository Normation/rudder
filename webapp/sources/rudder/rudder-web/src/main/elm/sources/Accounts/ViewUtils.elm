...
getSortFunction model a1 a2 =
    let
        datePickerInfo =
            model.ui.datePickerInfo

        order =
            case model.ui.filters.tableFilters.sortBy of
                Id ->
                    N.compare a1.id a2.id

                ExpDate ->
                    let
                        expDate1 =
                            case expirationDate a1.expirationPolicy of
                                Just d ->
                        ...
                        expDate2 =
                            case expirationDate a2.expirationPolicy of
                                Just d ->
                                    posixToString datePickerInfo d
                ...
                CreDate ->
                    N.compare a1.creationDate a2.creationDate

                _ ->
                    N.compare a1.name a2.name
    in
...
cleanDate date =
    slice 0 16 (String.replace "T" " " date)
