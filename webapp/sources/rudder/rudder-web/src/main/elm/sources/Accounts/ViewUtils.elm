    ...
    trAccount a =
      ...
      in
        ...
        , td [class "date"]
          [ span
            ( lastUsedDate
                |> Maybe.Extra.unpack (\() -> []) (\d -> [
                  class "text-secondary"
                , attribute "data-bs-toggle" "tooltip"
                , attribute "data-bs-placement" "top"
                , attribute "title" (buildTooltipContent "Token last used on" d)
                ])
            )
        ...
        , td []
          ...
          , span
            [ attribute "data-bs-toggle" "tooltip"
            , attribute "data-bs-placement" "top"
            , attribute "title" (buildTooltipContent "Token" (a.tokenGenerationDate |> Maybe.Extra.unpack (\_ -> "Generate a token for this account") (posixToString model.ui.datePickerInfo.zone >> (String.append "Token created or refreshed at "))))
            ]
            [ button
