...
init flags =
    let
        ...
        initFilters =
            Filters Rudder.Filters.empty []

        initUI =
            UI initFilters NoModal flags.hasWriteRights True
        ...
        initModel =
            Model flags.contextPath Loading initUI initCategory Dict.empty initTable exportCsvOptions.csvExport
                    ...
                    case ( compliance1, compliance2 ) of
                        ( Just c1, Just c2 ) ->
                            case ( complianceDataAvailable c1, complianceDataAvailable c2 ) of
                                ( True, True ) ->
                                    compare c1.compliance c2.compliance
