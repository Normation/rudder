...
import Html.String.Attributes exposing (attribute, class, style, title)
            ...
            case value of
                Just v ->
                    let
                        ...
                        titleTxt =
                            "<b>" ++ String.Extra.humanize id ++ ":</b> " ++ valueTxt
                    in
                    span
        ...
        NewScore value ->
            case Json.Decode.decodeValue decodeSystemUpdateStats value of
                Ok compliance ->
                    let
                        cmd =
                            buildScoreDetails compliance |> Html.String.toString 0 |> sendHtml
                    in
                    ( model, cmd )
