...
class MockDirectives(mockTechniques: MockTechniques) {
  ...
  object directives {
    ...
    val fileTemplateVariables2 = Directive(
      ...
      "directive ff44fb97-b65e-43c4-b8c2-0df8d5e8549f",
      "",
      None,
      ""
    )
  ...
  val rootActiveTechniqueCategory = RefM
    .make(
  ...
  object directiveRepo extends RoDirectiveRepository with WoDirectiveRepository with DirectiveRevisionRepository {
    ...
    def deleteGen(id: DirectiveUid) = {
      ...
      rootActiveTechniqueCategory
        .modify(r => (r.allDirectives.get(DirectiveId(id, GitVersion.DEFAULT_REV)), r.deleteDirective(id)).succeed)
...
class MockRules() {
  ...
  object ruleCategoryRepo extends RoRuleCategoryRepository with WoRuleCategoryRepository {
    ...
    override def delete(
      ...
      categories.update(cats => inDelete(cats, category).succeed).map(_ => category)
    }
  }
...
class MockNodeGroups(nodesRepo: MockNodes) {
  ...
  val g0     = NodeGroup(
    NodeGroupId("0000f5d3-8c61-4d20-88a7-bb947705ba8a"),
    "Real nodes",
    "",
    g0props,
    None,
  ...
  val g2     =
    NodeGroup(NodeGroupId("2222f5d3-8c61-4d20-88a7-bb947705ba8a"), "only root", "", Nil, None, false, Set(NodeId("root")), true)
  val g3     = NodeGroup(
    NodeGroupId("3333f5d3-8c61-4d20-88a7-bb947705ba8a"),
    "Even nodes",
    "",
    Nil,
    None,
  ...
  val g4     = NodeGroup(
    NodeGroupId("4444f5d3-8c61-4d20-88a7-bb947705ba8a"),
    "Odd nodes",
    "",
    Nil,
    None,
  ...
  val g5     = NodeGroup(
    NodeGroupId("5555f5d3-8c61-4d20-88a7-bb947705ba8a"),
  ...
  val g6     = NodeGroup(
    NodeGroupId("6666f5d3-8c61-4d20-88a7-bb947705ba8a"),
    ...
    List(
      FullRuleTargetInfo(
        FullGroupTarget(
          ...
          NodeGroup(
            NodeGroupId("a-group-for-root-only"),
            "Serveurs [€ðŋ] cassés",
