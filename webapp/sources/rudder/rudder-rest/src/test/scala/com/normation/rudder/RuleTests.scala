...
class RuleTest extends Specification with Loggable {
  ...
  "Testing rule utility tools" should {
    ...
    "Find missing categories" in {
      ...
      val cat1 = RuleCategory(RuleCategoryId("missing-cat1"), "<missing-cat1>", s"Category missing-cat1 has been deleted, please move rules to available categories", List(), false)
      val cat2 = RuleCategory(RuleCategoryId("missing-cat2"), "<missing-cat2>", s"Category missing-cat2 has been deleted, please move rules to available categories", List(), false)
