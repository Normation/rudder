...
class GroupsApi(
  ...
  object GroupInheritedProperties extends LiftApiModuleString {
    val schema: GroupApi.GroupInheritedProperties.type = API.GroupInheritedProperties
  ...
  object GroupDisplayInheritedProperties extends LiftApiModuleString {
    val schema: GroupApi.GroupDisplayInheritedProperties.type = API.GroupDisplayInheritedProperties
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object Delete extends LiftApiModuleString {
    val schema: GroupApi.DeleteGroup.type = API.DeleteGroup
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object Create extends LiftApiModule0      {
    val schema: GroupApi.CreateGroup.type = API.CreateGroup
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      if (req.json_?) {
        req.json match {
  ...
  object Update extends LiftApiModuleString {
    val schema: GroupApi.UpdateGroup.type = API.UpdateGroup
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object Reload extends LiftApiModuleString {
    val schema: GroupApi.ReloadGroup.type = API.ReloadGroup
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object GetTree        extends LiftApiModule0      {
    val schema: GroupApi.GetGroupTree.type = API.GetGroupTree
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
  ...
  object GetCategory    extends LiftApiModuleString {
    val schema: GroupApi.GetGroupCategoryDetails.type = API.GetGroupCategoryDetails
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object DeleteCategory extends LiftApiModuleString {
    val schema: GroupApi.DeleteGroupCategory.type = API.DeleteGroupCategory
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object UpdateCategory extends LiftApiModuleString {
    val schema: GroupApi.UpdateGroupCategory.type = API.UpdateGroupCategory
    val restExtractor = restExtractorService
    def process(
        version:    ApiVersion,
        path:       ApiPath,
  ...
  object CreateCategory extends LiftApiModule0      {
    val schema: GroupApi.CreateGroupCategory.type = API.CreateGroupCategory
    val restExtractor = restExtractorService
    def process0(version: ApiVersion, path: ApiPath, req: Req, params: DefaultParams, authzToken: AuthzToken): LiftResponse = {
      implicit val action = schema.name
