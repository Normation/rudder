...
trait ReadConfigService {
  ...
  def rudder_generation_max_parrallelism(): IOResult[String]
...
/**
  ...
  def set_rudder_generation_max_parrallelism(value: String): IOResult[Unit]
...
class LDAPBasedConfigService(
  ...
  val defaultConfig =
    s"""rudder.ui.changeMessage.enabled=true
       ...
       rudder.generation.max.parrallelism=1x
  ...
  def rudder_generation_max_parrallelism(): IOResult[String] = get("rudder_generation_max_parrallelism")
  def set_rudder_generation_max_parrallelism(value: String): IOResult[Unit] = save("rudder_generation_max_parrallelism", value)
