...
trait ReadConfigService {
  ...
  def rudder_generation_max_parrallelism(): Box[String]
...
/**
  ...
  def set_rudder_generation_max_parrallelism(value: String): Box[Unit]
...
class LDAPBasedConfigService(
  ...
  def rudder_generation_max_parrallelism(): Box[String] = get("rudder_generation_max_parrallelism")
  def set_rudder_generation_max_parrallelism(value: String): Box[Unit] = save("rudder_generation_max_parrallelism", value)
