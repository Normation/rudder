...
final case class ReloadTechniqueLibrary(
  ...
  override val eventType: EventLogType = ReloadTechniqueLibrary.eventType
}
...
final case class AddTechnique(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = AddTechnique.eventType
}
...
final case class ModifyTechnique(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = ModifyTechnique.eventType
}
...
final case class DeleteTechnique(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = DeleteTechnique.eventType
}
