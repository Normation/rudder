...
object Reports {
  ...
  def factory(
    ...
    severity.toLowerCase match {
      ...
      case AUDIT_NONCOMPLIANT =>
        new AuditNonCompliantReport(
          executionDate,
          ruleId,
          directiveId,
          nodeId,
      ...
      case AUDIT_NOTAPPLICABLE =>
        new AuditNotApplicableReport(
          executionDate,
          ruleId,
          directiveId,
          nodeId,
