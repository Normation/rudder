...
/*
 * This one is the one that is serialized to JSON. The field names must be the one
 * expected by API/client side. Order matters.
 */
final case class ComplianceSerializable(
    pending:            OptPosNum,
    notApplicable:      OptPosNum,
    success:            OptPosNum,
    repaired:           OptPosNum,
    error:              OptPosNum,
    compliant:          OptPosNum,
    nonCompliant:       OptPosNum,
    auditError:         OptPosNum,
    auditNotApplicable: OptPosNum,
    unexpected:         OptPosNum,
    missing:            OptPosNum,
    noAnswer:           OptPosNum,
...
object ComplianceSerializable {
  ...
  def empty = ComplianceSerializable(
    OptPosNum.none,
    OptPosNum.none,
    OptPosNum.none,
    OptPosNum.none,
...
object CompliancePercent {
  ...
  // transform to ComplianceSerializable with the logic that negative and 0 value becomes None and won't
  // appear into resulting JSON.
  implicit val transformCompliancePercent: Transformer[CompliancePercent, ComplianceSerializable] =
    Transformer.define[CompliancePercent, ComplianceSerializable].buildTransformer
...
object ComplianceLevelSerialisation {
  ...
  implicit val transformComplianceLevelSerialisation: Transformer[ComplianceLevelSerialisation, ComplianceLevel] =
    Transformer.define[ComplianceLevelSerialisation, ComplianceLevel].buildTransformer

  implicit val transformComplianceLevel: Transformer[ComplianceLevel, ComplianceLevelSerialisation] =
    Transformer.define[ComplianceLevel, ComplianceLevelSerialisation].buildTransformer
