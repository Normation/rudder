...
object GenericProperty {
   ...
   */
  def parseConfig(name: String, revId: Option[RevId], value: String, mode: Option[InheritMode], provider: Option[PropertyProvider], description: Option[String], options: ConfigParseOptions = ConfigParseOptions.defaults()): PureResult[Config] = {
    parseValue(value).map { v =>
      toConfig(name, revId, v, mode, provider, description, options)
    }
  }
   ...
   */
  def toConfig(name: String, revId: Option[RevId], value: ConfigValue, mode: Option[InheritMode], provider: Option[PropertyProvider], description: Option[String], options: ConfigParseOptions = ConfigParseOptions.defaults()): Config = {
    val m = new java.util.HashMap[String, ConfigValue]()
...
object NodeProperty {
  ...
  def parse(name: String, value: String, mode: Option[InheritMode], provider: Option[PropertyProvider]): PureResult[NodeProperty] = {
    GenericProperty.parseConfig(name, None, value, mode, provider, None).map(c => new NodeProperty(c))
  }
  def apply(name: String, value: ConfigValue, mode: Option[InheritMode], provider: Option[PropertyProvider]): NodeProperty = {
    new NodeProperty(GenericProperty.toConfig(name, None, value, mode, provider, None))
  }
...
object GroupProperty {
   ...
   * used as json.
   */
  def parse(name: String, revId: Option[RevId], value: String, mode: Option[InheritMode], provider: Option[PropertyProvider]): PureResult[GroupProperty] = {
    GenericProperty.parseConfig(name, revId, value, mode, provider, None).map(c => new GroupProperty(c))
  }
  def apply(name: String, revId: Option[RevId], value: ConfigValue, mode: Option[InheritMode], provider: Option[PropertyProvider]): GroupProperty = {
    new GroupProperty(GenericProperty.toConfig(name, revId, value, mode, provider, None))
  }
