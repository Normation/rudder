...
import com.normation.rudder.facts.nodes.{NodeFactRepository, QueryContext}
...
class ScoreServiceImpl(globalScoreRepository: GlobalScoreRepository, scoreRepository: ScoreRepository, nodeFactRepo: NodeFactRepository) extends ScoreService {
