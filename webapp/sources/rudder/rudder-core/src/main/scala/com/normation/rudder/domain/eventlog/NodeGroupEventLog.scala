...
final case class AddNodeGroup(
  ...
  override val eventType: EventLogType = AddNodeGroup.eventType
}
...
final case class DeleteNodeGroup(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = DeleteNodeGroup.eventType
}
...
final case class ModifyNodeGroup(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = ModifyNodeGroup.eventType
}
