...
final case class AddChangeRequest(
  ...
  override val eventType: EventLogType = AddChangeRequest.eventType
}
...
final case class DeleteChangeRequest(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = DeleteChangeRequest.eventType
}
...
final case class ModifyChangeRequest(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = ModifyChangeRequest.eventType
}
