...
object CfengineBundleVariables {
  ...
  def cleanup(techniqueName: String) = TechniqueBundles(Directive(techniqueName), dryRun(techniqueName), Nil, enforce :: Nil, Nil, false, false, PolicyMode.Enforce, false)
