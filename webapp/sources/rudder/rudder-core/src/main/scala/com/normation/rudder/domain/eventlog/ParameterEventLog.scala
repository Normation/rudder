...
final case class AddGlobalParameter(
  ...
  override val eventType: EventLogType = AddGlobalParameter.eventType
}
...
final case class ModifyGlobalParameter(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = ModifyGlobalParameter.eventType
}
...
final case class DeleteGlobalParameter(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = DeleteGlobalParameter.eventType
}
