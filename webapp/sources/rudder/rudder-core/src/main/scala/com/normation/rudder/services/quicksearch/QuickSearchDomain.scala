...
object QuickSearchResultId {
  ...
  final case class QRNodeId(value: String)      extends AnyVal with QuickSearchResultId { override def tpe: QSObject = Node      }
  final case class QRGroupId(value: String)     extends AnyVal with QuickSearchResultId { override def tpe: QSObject = Group     }
  final case class QRDirectiveId(value: String) extends AnyVal with QuickSearchResultId { override def tpe: QSObject = Directive }
  final case class QRParameterId(value: String) extends AnyVal with QuickSearchResultId { override def tpe: QSObject = Parameter }
  final case class QRRuleId(value: String)      extends AnyVal with QuickSearchResultId { override def tpe: QSObject = Rule      }
}
