...
final case class AddSecret(
  ...
  override val eventType: EventLogType = AddSecret.eventType
}
...
final case class ModifySecret(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = ModifySecret.eventType
}
...
final case class DeleteSecret(
  ...
  override val cause:     Option[Int]  = None
  override val eventType: EventLogType = DeleteSecret.eventType
}
