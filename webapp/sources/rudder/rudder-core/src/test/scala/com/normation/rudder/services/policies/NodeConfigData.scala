...
class TestNodeConfiguration(prefixTestResources: String = "") {
  ...
  def commonVariables(nodeId: NodeId, allNodeInfos: Map[NodeId, NodeInfo]): Map[(List[String],String), Variable
  ] = {
  ...
  def draft (
    ...
    , technique     : Technique
    , variableMap   : Map[(List[String],String), Variable]
  ...
  val rolesVariables = {
     Map[(List[String],String), Variable]()
  }
  ...
  lazy val clockVariables: Map[(List[String],String),Variable] = {
  ...
  lazy val rpmVariables: Map[(List[String],String), Variable] = {
  ...
  lazy val pkgVariables: Map[(List[String],String),Variable] = {
  ...
  lazy val fileTemplateVariables1: Map[(List[String],String), Variable]   = {
  ...
  lazy val fileTemplate2 = {
    ...
    draft(
      ...
      , "20-File template 2"
      , fileTemplateTechnique
      , fileTemplateVariables2.map(a => ((Nil,a._1), a._2))
      , fileTemplateTechnique.trackerVariableSpec.toVariable(Seq(id.getReportId))
      , BundleOrder("60-rule-technique-std-lib")
  ...
  val ncf1 = {
    ...
    draft(
      ...
      , "Create a file"
      , ncf1Technique
      , ncf1Variables.map(a => ((Nil,a._1), a._2))
  ...
  def copyGitFileDirectives(i:Int) = {
    ...
    draft(
      ...
      , copyGitFileVariable(i).map(a => ((Nil,a._1), a._2))
  ...
  lazy val gvd1 = {
    ...
    draft(
      ...
      , gvdTechnique
      , gvdVariables1.map(a => ((Nil,a._1), a._2))
  ...
  lazy val gvd2 = {
    ...
    draft(
      ...
      , gvdTechnique
      , gvdVariables2.map(a => ((Nil,a._1), a._2))
      , gvdTechnique.trackerVariableSpec.toVariable(Seq(id.getReportId))
      , BundleOrder("10. Global configuration for all nodes")
