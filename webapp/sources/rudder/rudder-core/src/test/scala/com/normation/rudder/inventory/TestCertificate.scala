...
class TestCertificate extends Specification with Loggable {
  ...
  val repository: mutable.Map[NodeId, FullInventory] = scala.collection.mutable.Map[NodeId, FullInventory]()

  // our callback logic to wait for save done
  var saveDone = false
  val callback:     Inventory => UIO[Unit] = (_: Inventory) => effectUioUnit { saveDone = true }
  ...
  val reportSaver: reportSaver = new reportSaver
  class reportSaver extends InventorySaver[Seq[LDIFChangeRecord]] {
  ...
  val fullInventoryRepo: FullInventoryRepository[Seq[LDIFChangeRecord]] = new FullInventoryRepository[Seq[LDIFChangeRecord]] {
...
object Cert {
  ...
  val KEY_CFE_OK: String = """-----BEGIN RSA PUBLIC KEY-----
  ...
  val CERT_WIN_OK: String = """-----BEGIN CERTIFICATE-----
  ...
  val CERT_WIN_NEW: String = """-----BEGIN CERTIFICATE-----
  ...
  val CERT_WIN_BAD: String = """-----BEGIN CERTIFICATE-----
