  ...
  "Reading old expected reports" should {
    ...
    "correctly read node0" in {
      ...
      val expected    = JsonNodeExpectedReports(
        ...
        List(
          RuleExpectedReports(
            "4bb75daa-a82f-445a-8e8e-af3e99608ffe",
            List(
              DirectiveExpectedReports(
                "73e069ea-de00-4b5d-a00e-012709b7b462",
                None,
                false,
                List(
                  ValueExpectedReport(
    ...
    "correctly read node1" in {
      ...
      val expected    = JsonNodeExpectedReports(
        ...
        List(
          ...
          RuleExpectedReports(
            "10023ce3-0775-4178-bd9f-1f3a61d81c7c",
            List(
              DirectiveExpectedReports(
                "b6478fd4-f2de-43b0-9f04-812ec0680e4d",
                None,
                false,
                List(
                  ValueExpectedReport(
              ...
              DirectiveExpectedReports(
                "37c57e98-328d-4cd2-8a71-33f2e449ba51",
                None,
                false,
                List(
                  ValueExpectedReport(
          ...
          RuleExpectedReports(
            ...
            List(
              DirectiveExpectedReports(
                "d2471d9b-5c7f-404e-9a03-970c36924f5c",
                None,
                false,
                List(
                  ValueExpectedReport(
              ...
              DirectiveExpectedReports(
                "86a0ef5b-1b98-4bda-8dc3-2940ad53beaa",
                None,
                false,
                List(
                  ValueExpectedReport(
                  ...
                  ValueExpectedReport(
                    "Line deletion regular expressions",
                    List(
                      ExpectedValueMatch("/tmp/${sys.fqhost}", "/tmp/${sys.fqhost}")
                    )
                  ),
                  ValueExpectedReport(
                    "Line replacement regular expressions",
                    List(
                      ExpectedValueMatch("/tmp/${sys.fqhost}", "/tmp/${sys.fqhost}")
                    )
                  ),
              ...
              DirectiveExpectedReports(
                "88e99dc6-c211-40fd-85a2-b1e8381fe0cb",
                None,
                false,
                List(
                  ValueExpectedReport(
              ...
              DirectiveExpectedReports(
                "6eae3c13-1d34-4643-b136-f82c143d8aa5",
                None,
                false,
                List(
                  ValueExpectedReport(
    ...
    "correctly read node2" in {
      ...
      val expected    = JsonNodeExpectedReports(
        ...
        List(
            ...
            List(
              DirectiveExpectedReports(
                ...
                List(
                  ...
                  ValueExpectedReport(
                    "Check apache boot script",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ValueExpectedReport(
                    "Check relayd boot script",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ...
                  ValueExpectedReport(
                    "Check configuration-repository folder",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ValueExpectedReport(
                    "Check configuration-repository GIT lock",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ValueExpectedReport(
                    "Check allowed networks configuration",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ...
                  ValueExpectedReport(
                    "Check LDAP in rudder-webapp.properties",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ...
                  ValueExpectedReport(
                    "Check SQL in rudder-webapp.properties",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ...
                  ValueExpectedReport(
                    "Check WebDAV properties",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ValueExpectedReport(
                    "Relayd service configuration",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  ),
                  ValueExpectedReport(
                    "Send metrics to rudder-project",
                    List(
                      ExpectedValueMatch("None", "None")
                    )
                  )
          ...
          RuleExpectedReports(
            "a3a796b9-8499-4e0b-86c5-975fc5a13505",
            List(
              DirectiveExpectedReports(
                "a73b40e0-d83c-474f-b617-7f634d232b8b",
                Some(PolicyMode.Enforce),
                false,
                List(
                  ValueExpectedReport(
          ...
          RuleExpectedReports(
            "eff9e40d-5ccf-450a-801a-d4432a7592e4",
            List(
              DirectiveExpectedReports(
                "dd4a5ee8-080d-452b-bfa8-9e46b459a804",
                None,
                false,
                List(
                  ValueExpectedReport(
