...
macro_rules! rudder_log {
    (target: $target:expr, $lvl:expr, $($arg:tt)+) => ({
        let lvl = $lvl;
        if lvl <= $crate::resource_type::cfengine::log::max_level() {
            std::println!(
                "log_{}={}",
...
macro_rules! rudder_critical {
    (target: $target:expr, $($arg:tt)+) => (
        rudder_log!(target: $target, $crate::resource_type::cfengine::log::Level::Critical, $($arg)+)
    );
    ($($arg:tt)+) => (
        rudder_log!($crate::resource_type::cfengine::Level::Critical, $($arg)+)
    )
}
...
macro_rules! rudder_error {
    (target: $target:expr, $($arg:tt)+) => (
        rudder_log!(target: $target, $crate::resource_type::cfengine::log::Level::Error, $($arg)+)
    );
    ($($arg:tt)+) => (
        rudder_log!($crate::resource_type::cfengine::log::Level::Error, $($arg)+)
    )
}
...
macro_rules! rudder_warning {
    (target: $target:expr, $($arg:tt)+) => (
        rudder_log!(target: $target, $crate::resource_type::cfengine::log::Level::Warning, $($arg)+)
    );
    ($($arg:tt)+) => (
        rudder_log!($crate::resource_type::cfengine::log::Level::Warning, $($arg)+)
    )
}
...
macro_rules! rudder_info {
    (target: $target:expr, $($arg:tt)+) => (
        rudder_log!(target: $target, $crate::resource_type::cfengine::log::Level::Info, $($arg)+)
    );
    ($($arg:tt)+) => (
        rudder_log!($crate::resource_type::cfengine::log::Level::Info, $($arg)+)
    )
}
...
macro_rules! rudder_debug {
    (target: $target:expr, $($arg:tt)+) => (
        rudder_log!(target: $target, $crate::resource_type::cfengine::log::Level::Debug, $($arg)+)
    );
    ($($arg:tt)+) => (
        rudder_log!($crate::resource_type::cfengine::log::Level::Debug, $($arg)+)
    )
}
...
macro_rules! rudder_trace {
    (target: $target:expr, $($arg:tt)+) => (
        rudder_log!(target: $target, $crate::resource_type::cfengine::log::Level::Trace, $($arg)+)
    );
    ($($arg:tt)+) => (
        rudder_log!($crate::resource_type::cfengine::log::Level::Trace, $($arg)+)
    )
}
