...
* a variable definition: `myvar = "value"`. Value can be of any primitive type
...
* a flow statement: `return` `log` `fail` `noop`
...
NOTE: see enum related syntax <<access-enum-content,here>>, inclunding items and range and expression examples