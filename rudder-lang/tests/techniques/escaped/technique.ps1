function Escaped {
  ...
  _rudder_common_report_na -ComponentName "Command execution result" -ComponentKey "rpm -qi gpg-pubkey-\\*|grep -E ^Packager|grep Innoflair" -Message "Not applicable" -ReportId $ReportId -TechniqueName $TechniqueName -AuditOnly:$AuditOnly
