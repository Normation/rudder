# Use custom CSS classes for tables
...
Do's and don'ts :
* ✅ Use our own CSS classes for tables
* ❌ Avoid using CSS classes that not mention DataTables (for ex. with the `dataTables_` prefix
* ✅ For new tables, since we use Elm, prefer using [our own library](https://github.com/Normation/rudder-elm-library)
