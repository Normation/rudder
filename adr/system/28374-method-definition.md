...
⚠️  When a GM is inside a **foreach** loop, its resulting condition outside of the loop should be the **worst-case** of the individual resulting conditions.
...
For worst case computation, we use by priority:

`error > repaired > kept > not_applicable`
