...
case class LDAPObjectType(
  ...
  def objectTypes = Map(
    ...
    "controllerPhysicalElemen" -> LDAPObjectType(dit.MACHINES.dn, Sub, ALL, ParentDNJoin),
  ...
  val objectDnTypes = Map(
    ...
    "controllerPhysicalElemen" -> QueryMachineDn,
  ...
  val joinAttributes = Map(
    ...
    "controllerPhysicalElemen" -> ParentDNJoin,
