...
About policy-generation-node-ready/ hooks
=========================================
...
one (technically, before we move /var/rudder/share/$NODEID/rules.new 
...
external services using knowledged from the generated policies 
