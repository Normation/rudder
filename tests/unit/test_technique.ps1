function content_escaping_test {
  ...
  $local_classes = Merge-ClassContext $local_classes $(Package-Install-Version -PackageName "apache2" -PackageVersion "2.2.11" -reportId $reportId -techniqueName $techniqueName -auditOnly:$auditOnly)
